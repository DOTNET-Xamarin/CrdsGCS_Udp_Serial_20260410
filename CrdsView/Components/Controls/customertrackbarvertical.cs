...
namespace CrdsView.Controls
{
    public partial class customertrackbarvertical : UserControl
    {
        ...
        float Edge_Scale_Width = 0.3f;//The ratio of the width of the left and right sides of the bounding
                                      //rectangle of the custom slider component to the width of the control
        float Edge_Scale_height = 0.03f;//The ratio of the height of the left and right sides of the bounding
                                        //rectangle of the custom slider component to the height of the control
