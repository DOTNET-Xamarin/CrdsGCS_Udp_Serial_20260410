...
namespace MyControl
{
    public partial class AltitudeCon : UserControl
    {
        ...
        float vertical = 1;// Vertical
        float Horizontal = 1;// Horizontal
    ...
    //    float 
        ...
        void DrawAltitude(Graphics ControlGraphics)
        {
            ...
            float resolution = 0.5f;// The height represented by each pixel point
            float startalt = alt - altHeigh / 2 * resolution;
            float endalt = alt + altHeigh / 2 * resolution;
            float everyscale = 3;// The altitude represented by each tick
            float shortlength = 0.1f * altWidth;
            float longlenght = 0.2f * ControlWidth;

            Font font = new System.Drawing.Font("Times New Roman", 8);
        ...
        void DrawSpeed(Graphics ControlGraphics)
        {
            ...
            float resolution = 0.5f;// Velocity represented by each pixel
            float startalt = speed - speedHeigh / 2 * resolution;
            float endalt = speed + speedHeigh / 2 * resolution;
            float everyscale = 3;// The speed represented by each tick
