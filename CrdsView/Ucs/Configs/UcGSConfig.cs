...
{
    public partial class UcGSConfig : UserControl
    {
        // serialport
        ...
        // ubx detection
        private ubx_m8p ubx_m8p = new ubx_m8p(); // U-blox M8P / F9P
        ...
        private int customMapIndexSelected = 0;
        private ManagementEventWatcher _watcher;

        public int CustomMapIndex
        {
            get { return customMapIndexSelected; }
        }
        public bool bSearchLightControl
        { 
            get { return SearchLight_Enable.Checked; }
        }
        public UcGSConfig()
        {
            InitializeComponent();
            ...
            SetSerialItems((System.Windows.Forms.ComboBox)cbRTCMSourceSelect);
            ...
            // BOB - 20251105 - inserted to refresh Serial Port list in real time 
            ...
            _watcher.Start();
            // EOB - 20251105 - inserted to refresh Serial Port list in real time
        }
        ...
        {
            // UI 스레드에서 갱신
            this.Invoke((MethodInvoker)RefreshPortList);
        }
        ...
        private void RefreshPortList()
        {
            ...
            cbRTCMSourceSelect.Items.Clear();
            cbRTCMSourceSelect.Items.AddRange(ports);
            sinkSelectorComboBox.Items.AddRange(ports);
        }
        // EOB - 20251105 - inserted to refresh Serial Port list in real time

        private void SetComboStringItem(System.Windows.Forms.ComboBox comboBox, string name)
        {
        ...
        private void LoadSettings()
        {
            ...
            SetComboStringItem(cbRTCMSourceSelect, settings.SourceType);
            SetComboStringItem(cbRTCMSourceBaudrate, settings.SourceBaudRate.ToString());
        ...
        private void SaveSettings()
        {
            ...
            settings.SourceType = cbRTCMSourceSelect.SelectedItem?.ToString();
            intValue = 0;
            int.TryParse(cbRTCMSourceBaudrate.SelectedItem?.ToString(), out intValue);
        ...
        private void SetSerialItems(System.Windows.Forms.ComboBox comboBox)
        {
                ...
                while (threadrun)
                {
                    try
                    {
                        ...
                        while (comPort.BytesToRead > 0)
                        {
                            ...
                            {
                                lastrecv = DateTime.Now;
                                //string hexStr = BitConverter.ToString(buffer).Replace("-", " ");
                            ...
                            for (int a = 0; a < read; a++)
                            {
                                ...
                                if ((seenmsg = rtcm3.Read(buffer[a])) > 0)
                                {
                                    ...
                                    Console.WriteLine(msgname + "(" + rtcm3.length.ToString() + ")");
        ...
        private void seenRTCM(int seenmsg)
        {
            ...
            //Console.WriteLine("RTCM MSG : " + seenmsg.ToString());
            ...
            BeginInvoke((Action)delegate ()
            {
                switch (seenmsg)
                {
                    ...
                    case 1087:
                        ...
                        SetTimeout(labelglonass, 10000, (Label obj) =>
                        {
                            obj.BackColor = Color.Red;
                            obj.Text = null;
        ...
        */
        ...
        private void buttonConnect_Click(object sender, EventArgs e)
        {
            ...
            if (comPort?.IsOpen ?? false)
            {
                ...
                cbRTCMSourceSelect.Enabled = true;
            }
            else
            {
                // TODO: trycatches
                status_line3 = null;
                var item = cbRTCMSourceSelect.SelectedItem;
                ...
                try
                {
                    ...
                    if (item != null)
                    {
                        ...
                        comPort.PortName = item.ToString();
                        comPort.BaudRate = Int32.Parse(cbRTCMSourceBaudrate.Text);
                        ...
                        if (m8pCheckBox.Checked)
                        {
                            ...
                            ubx_m8p.SetupM8P(comPort, m8pFw130CheckBox.Checked, movingBaseCheckBox.Checked);
                        ...
                        cbRTCMSourceSelect.Enabled = false;
                        cbRTCMSourceBaudrate.Enabled = false;
                    }
                }
                catch (Exception ex)
                {
        ...
        */
        ...
        private void SearchLight_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetSearchLightControl(SearchLight_Enable.Checked);
        }

        /* 20251105 - check box deleted
        private void EOIRCamera_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetEOIRCameraControl(EOIRCamera_Enable.Checked);
        }
        */

        private void SpeakerControl_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetSpeakerControl(SpeakerControl_Enable.Checked);
        }

        private void CCTV_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetCCTVControl(CCTV_Enable.Checked);
        }

        private void ParachuteControl_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetParachuteControl(ParachuteControl_Enable.Checked);
        }

        /* 20251105 - check box deleted
        private void VirtualJoystick_Enable_CheckedChanged(object sender, EventArgs e)
        {
            ConfigController.Instance.SetVirtualJoystickControl(VirtualJoystick_Enable.Checked);
        }
        */
        ...
        private void cbMap_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                this.customMapIndexSelected = cbMap.SelectedIndex;              
                    
                ConfigController.Instance.SetCustomMapIndex(this.customMapIndexSelected);
            }
        }
    }
 }
