...
namespace CrdsModel.Mavlink
{
    ...
    #region TODO : # 67 ~ # 73
    [MessageInfo(69, 30, 243,
        "Manual Control.")]
    public class Message_MANUAL_CONTROL : Message
    {
        ...
        /// <summary>Set bits to 1 to indicate which of the following extension fields contain valid data: bit 0: pitch, bit 1: roll, bit 2: aux1, bit 3: aux2, bit 4: aux3, bit 5: aux4, bit 6: aux5, bit 7: aux6   </summary>
        //[FieldOffset(13)]
        ...
        /// <summary>Aux continuous input field 1. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 2 of enabled_extensions field is set. 0 if bit 2 is unset.   </summary>
        //[FieldOffset(18)]
        public short aux1;

        /// <summary>Aux continuous input field 2. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 3 of enabled_extensions field is set. 0 if bit 3 is unset.   </summary>
        //[FieldOffset(20)]
        public short aux2;

        /// <summary>Aux continuous input field 3. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 4 of enabled_extensions field is set. 0 if bit 4 is unset.   </summary>
        //[FieldOffset(22)]
        public short aux3;

        /// <summary>Aux continuous input field 4. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 5 of enabled_extensions field is set. 0 if bit 5 is unset.   </summary>
        //[FieldOffset(24)]
        public short aux4;

        /// <summary>Aux continuous input field 5. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 6 of enabled_extensions field is set. 0 if bit 6 is unset.   </summary>
        //[FieldOffset(26)]
        public short aux5;

        /// <summary>Aux continuous input field 6. Normalized in the range [-1000,1000]. Purpose defined by recipient. Valid data if bit 7 of enabled_extensions field is set. 0 if bit 7 is unset.   </summary>
        //[FieldOffset(28)]
        public short aux6;

        public Message_MANUAL_CONTROL(short x, short y, short z, short r, ushort buttons, byte target, ushort buttons2,
            byte enabled_extensions, short s, short t, short aux1, short aux2, short aux3, short aux4, short aux5, short aux6)
            : base(x, y, z, r, buttons, target, buttons2, enabled_extensions, s, t, aux1, aux2, aux3, aux4, aux5, aux6)
        {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        public Message_MANUAL_CONTROL()
        {

        }
    }

    [MessageInfo(70, 38, 124,
        "RC Channels Override.")]
    public class Message_RC_CHANNELS_OVERRIDE : Message
    {
        ...
        public Message_RC_CHANNELS_OVERRIDE(ushort chan1_raw, ushort chan2_raw, ushort chan3_raw, ushort chan4_raw, ushort chan5_raw, ushort chan6_raw, ushort chan7_raw, ushort chan8_raw, 
            byte target_system, byte target_component, ushort chan9_raw, ushort chan10_raw, ushort chan11_raw, ushort chan12_raw, ushort chan13_raw, ushort chan14_raw, ushort chan15_raw, ushort chan16_raw, ushort chan17_raw, ushort chan18_raw)
            : base(chan1_raw, chan2_raw, chan3_raw, chan4_raw, chan5_raw, chan6_raw, chan7_raw, chan8_raw,
            target_system, target_component, chan9_raw, chan10_raw, chan11_raw, chan12_raw, chan13_raw, chan14_raw, chan15_raw, chan16_raw, chan17_raw, chan18_raw)
        {
            this.chan1_raw = chan1_raw;
            this.chan2_raw = chan2_raw;
            this.chan3_raw = chan3_raw;
        ...
        public Message_RC_CHANNELS_OVERRIDE()
        {
    ...
    /// Ardupilot
    /// </summary>
    [MessageInfo(123, 113, 250,
        "GPS_INJECT_DATA." + " Data for injecting into the onboard GPS (used for DGPS)")]
    public class Message_GPS_INJECT_DATA : Message
    {
        public Message_GPS_INJECT_DATA()
        {

        }

        public Message_GPS_INJECT_DATA(byte target_system, byte target_component, byte len, byte[] data)
            : base(target_system, target_component, len, data)
        {
            this.target_system = target_system;
            this.target_component = target_component;
            this.len = len;
    ...
    /// Ardupilot
    /// </summary>
    [MessageInfo(169, 18, 234,
        "DATA16.")]
    public class Message_DATA16 : Message
    {
        public Message_DATA16()
        {

        }

        public Message_DATA16(byte type, byte len, byte[] data)
            : base(type, len, data)
        {
            this.type = type;
            this.len = len;
    ...
    /// Ardupilot
    /// </summary>
    [MessageInfo(170, 34, 73,
        "DATA32.")]
    public class Message_DATA32 : Message
    {
        public Message_DATA32()
        {

        }

        public Message_DATA32(byte type, byte len, byte[] data)
            : base(type, len, data)
        {
            this.type = type;
            this.len = len;
    ...
    /// Ardupilot
    /// </summary>
    [MessageInfo(171, 66, 181,
        "DATA64.")]
    public class Message_DATA64 : Message
    {
        public Message_DATA64()
        {

        }

        public Message_DATA64(byte type, byte len, byte[] data)
            : base(type, len, data)
        {
            this.type = type;
            this.len = len;
    ...
    /// Ardupilot
    /// </summary>
    [MessageInfo(172, 98, 22,
        "DATA96.")]
    public class Message_DATA96 : Message
    {
        public Message_DATA96()
        {

        }

        public Message_DATA96(byte type, byte len, byte[] data)
            : base(type, len, data)
        {
            this.type = type;
            this.len = len;
    ...
    [MessageInfo(232, 63, 151,
        "GPS INPUT Data.")]
    public class Message_GPS_INPUT : Message
    {
        public Message_GPS_INPUT()
        {

        }

        public Message_GPS_INPUT(ulong time_usec, uint time_week_ms, int lat, int lon, float alt, float hdop,
            float vdop, float vn, float ve, float vd, float speed_accuracy, float horiz_accuracy, float vert_accuracy,
            ushort ignore_flags, ushort time_week, byte gps_id, byte fix_type, byte satellites_visible)
        : base(time_usec, time_week_ms, lat, lon, alt, hdop,
            vdop, vn, ve, vd, speed_accuracy, horiz_accuracy, vert_accuracy,
            ignore_flags, time_week, gps_id, fix_type, satellites_visible)
        {
            this.time_usec = time_usec;
    ...
    [MessageInfo(233, 182, 35,
        "GPS RTCM Data.")]
    public class Message_GPS_RTCM_DATA : Message
    {
        public Message_GPS_RTCM_DATA()
        {

        }

        public Message_GPS_RTCM_DATA(byte flags, byte len, byte[] data)
        : base(flags, len, data)
        {
            this.flags = flags;
            this.len = len;
    ...
    [MessageInfo(246, 38, 184,
        "ASDB VEHICLE")]
    public class Message_ADSB_VEHICLE : Message
    {
        public Message_ADSB_VEHICLE()
        {

        }
        public Message_ADSB_VEHICLE(uint ICAO_address, int lat, int lon, int altitude,
            ushort heading, ushort hor_velocity, short ver_velocity, ushort flags,
            ushort squawk, byte altitude_type, byte[] callsign, byte emitter_type, byte tslc)
            : base(ICAO_address, lat, lon, altitude,
            heading, hor_velocity, ver_velocity, flags,
