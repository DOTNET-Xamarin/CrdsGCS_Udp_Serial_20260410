...
{
    public class ComPort : System.IO.Ports.SerialPort
    {
        #region Subscribe
        ...
        public async Task<byte[]> ReadMavlink()
        {
            ...
            //Console.WriteLine("CommPort.ReadMavlink entered.");
            //EOB - 20260331 - debug

            await _semaphore.WaitAsync();
            try
            {
                if (this.ReadTimeout != 8000)
                {
                ...
                while (true)
                {
                    ...
                    if (stx == 0xFD | stx == 0xFE)
                    {
                        ...
                        //BOB - 20260331 - debug - show ReadMavlink called and bytes to read
                        //Console.WriteLine("CommPort.ReadMavlink packet len = " + packet.Length);
                        //EOB - 20260331 - debug
        ...
        public new bool Open()
        {
            try
            {
                ...
                {
                    base.Open();
                    this.WriteTimeout = 3000; // 500ms // default wirte timeout as win32
                }
