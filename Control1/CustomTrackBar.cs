...
namespace SpaceArrow.Control
{
    public partial class CustomTrackBar : UserControl
    {
        ...
        float Edge_Scale_Width = 0.03f;//The ratio of the width of the left and right sides of the bounding
                                       //rectangle of the custom slider component to the width of the control
        float Edge_Scale_height = 0.3f;//The ratio of the height of the left and right sides of the bounding
