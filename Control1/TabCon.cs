...
namespace MyControl
{
    public partial class MyTabCon : UserControl, IDisposable
    {
        ...
        SolidBrush b;
        private Font font = new Font("Times New Roman", 10); //Font and size of characters
        Pen p = null;
        ...
        void DrawSpeed()
        {
            ...
            float everyscale = 2;//The speed represented by each tick
       ...
       void DrawGPS()
       {
           Font font = new Font("Times New Roman", 0.028f * (this.Width > this.Height ? this.Height : this.Width));
        ...
        void DrawAltitude()
        {
            ...
            float everyscale = 1;//The altitude represented by each tick
            float shortlength = 0.2f * altWidth;
            float longlenght = 0.3f * altWidth;

            Font font = new System.Drawing.Font("Times New Roman", 8,FontStyle.Bold);
