...
namespace CrdsController.Controllers
{
    public class MonitorController
    {
        ...
        public void SetMonitoringDataStream()
        {
            ...
            InterfaceController.Instance.GetCurrentVehicle().DoSubscribeDataStream(34); //Message_RC_CHANNELS_SCALED
            InterfaceController.Instance.GetCurrentVehicle().DoSubscribeDataStream(35); //Message_RC_CHANNELS_RAW
            InterfaceController.Instance.GetCurrentVehicle().DoSubscribeDataStream(65); //Message_RC_CHANNELS
            InterfaceController.Instance.GetCurrentVehicle().DoSubscribeDataStream(30); //Message_ATTITUDE
            InterfaceController.Instance.GetCurrentVehicle().DoSubscribeDataStream(74); //Message_VFR_HUD
